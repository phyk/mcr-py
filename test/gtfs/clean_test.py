...
def test_split_routes_by_direction(trips_df: pl.DataFrame):
...
def test_create_paths_df(trips_df: pl.DataFrame, stop_times_df: pl.DataFrame):
...
def test_add_unique_route_ids(paths_df: pl.DataFrame):
...
def test_add_first_stop_info(trips_df: pl.DataFrame, stop_times_df: pl.DataFrame):
